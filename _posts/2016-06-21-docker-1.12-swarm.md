...
Users running docker beta for Mac & Windows will need to download docker-machine only and use the appropriate driver (xhyve / hyper-v) as docker should be upgraded automatically.
